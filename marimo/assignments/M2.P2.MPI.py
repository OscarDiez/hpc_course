...
def _(os, subprocess):
    ...
    _run_command = 'mpirun -np 4 ./mpi_hello'
...
def _(os, subprocess):
    ...
    if os.path.exists(_executable_path):
        ...
        print('Compilation failed.')
    _run_command = f'mpirun --oversubscribe -np 2 ./mpi_pingpong'
    _run_process = subprocess.run(_run_command, shell=True, capture_output=True, text=True)
    print('Running the MPI program...')
    if _run_process.stdout:
        print('Program Output:\n', _run_process.stdout)
...
def _(os, subprocess):
    ...
    if os.path.exists(_executable_path):
        ...
        print('Compilation failed.')
    _run_command = f'mpirun --oversubscribe -np 2 ./mpi_sync_async'
    _run_process = subprocess.run(_run_command, shell=True, capture_output=True, text=True)
    print('Running the MPI program...')
    if _run_process.stdout:
        print('Program Output:\n', _run_process.stdout)
...
def _(os, subprocess):
    ...
    if os.path.exists(_executable_path):
        ...
        print('Compilation failed.')
    _run_command = f'mpirun --oversubscribe -np 4 ./mpi_point_to_point_collective'
    _run_process = subprocess.run(_run_command, shell=True, capture_output=True, text=True)
    print('Running the MPI program...')
    if _run_process.stdout:
        print('Program Output:\n', _run_process.stdout)
