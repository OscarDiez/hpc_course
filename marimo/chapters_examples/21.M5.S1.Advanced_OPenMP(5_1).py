...
def _(os, subprocess):
    ...
    compilation_status_6 = subprocess.run(['gcc', '-fopenmp', 'nbody_simulation.c', '-o', 'nbody_simulation', '-lm'], capture_output=True, text=True)
    if compilation_status_6.returncode == 0:
        ...
        print('Compilation failed. Please check the code for errors.')
        print('Error message:')
        print(compilation_status_6.stderr)
    return
