...
def _():
    ...
    def train_model(model, optimizer, criterion):
        ...
        loss.backward()
        grad_norms = track_gradients(_model)
        _optimizer.step()
        return grad_norms
    ...
    grad_baseline = train_model(baseline_model, optimizer_baseline, _criterion)
    grad_relu = train_model(relu_model, optimizer_relu, _criterion)
    grad_batchnorm = train_model(batchnorm_model, optimizer_batchnorm, _criterion)
    grad_resnet = train_model(resnet_model, optimizer_resnet, _criterion)
